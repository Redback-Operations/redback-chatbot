# -*- coding: utf-8 -*-
"""cleaned_chatbot (1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1zxtNJy5wbFpKh5wMQgcgj0pPAkM9S6_o
"""

import pandas as pd

nRowsRead = None
text1 = pd.read_csv('/Mental_Health_FAQ.csv')
...
while True:
    ...
    if question.lower()=='quit':
        break
    # Encode the question
    encoded_question=torch.tensor(encode(question),dtype=torch.long,
